package com.pvpdojo.combat.equipment;

import com.pvpdojo.PVPDojoPlugin;
import com.pvpdojo.character.datatypes.SpellData;
...
{
    private static final Logger log = LoggerFactory.getLogger(EquipmentUtility.class);
